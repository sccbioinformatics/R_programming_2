...
$ echo "# SCAP" >> README.md
$ git init
$ git add DESCRIPTION  man  NAMESPACE  R  README.md  SCAP.Rproj
...
Before we can build the documentation we need to install the package that will do it:

```{r}
install.packages("roxygen2")
```

Go to "More" > "Configure Build Tools..." and check the box that says "Generate documentation with Roxygen". At the bottom check "Install and restart". NJow when you install the package Rstudio will automatically generate the hello.Rd file from the lines of documentation you have written above.
...
You add a package nby making an imports section:
